...
jump: {
  ...
  commands: [
    [
      ...
      { input: [range.variable, range.positiveInt], type: 'input' },
      { subcommand: 'equal', type: 'setable', canWrite: false },
      { input: [range.variable, range.int, range.float, range.special, range.teams, range.hex, range.boolean, range.blocks, range.items, range.liquids, range.units], type: 'input' },
      { input: [range.variable, range.int, range.float, range.special, range.teams, range.hex, range.boolean, range.blocks, range.items, range.liquids, range.units], type: 'input' },
    ],
    [
      'if {1} not {2}',
